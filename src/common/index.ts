...
export { default as DeleteModal } from '@/common/DeleteModal.vue'
export { default as CreateUserModal } from '@/common/CreateUserModal.vue'
export { default as VerifyUserModal } from '@/common/VerifyUserModal.vue'
export { default as PermissionModal } from '@/common/PermissionModal.vue'
